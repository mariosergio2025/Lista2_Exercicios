...
namespace Exercicio0
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("");
            int emNotas= (int)Math.Floor(convertidoEmDollar);
            Console.WriteLine("Mas considerando que a casa de cabio não trabalho com moedas de outros paises");
            Console.WriteLine("------------------------------------------------------------------------");
            Console.Write($"Entao voce podera ter {emNotas.ToString("c", CultureInfo.CreateSpecificCulture("en-us"))}");
            decimal sobraEmReal = (convertidoEmDollar - emNotas) * cotacaoDolar;
            Console.WriteLine($" e tem sobra {sobraEmReal.ToString("C",CultureInfo.CreateSpecificCulture("pt-BR"))} sem trocar");
            Console.WriteLine("");
            Console.WriteLine("");
        }
    }
